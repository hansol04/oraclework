...
CREATE TABLE TB_PUBLISHER_2(
    PUB_NO NUMBER CONSTRAINT PUBLISHER_PK PRIMARY KEY,
    PUB_NAME VARCHAR2(50) CONSTRAINT PUBLISHER_NN NOT NULL,
    PHONE VARCHAR2(13)
);

INSERT INTO TB_PUBLISHER_2 VALUES(1,'더조은출판사','02-111-2222');
INSERT INTO TB_PUBLISHER_2 VALUES(2,'정보출판사','02-111-2222');
INSERT INTO TB_PUBLISHER_2 VALUES(3,'한빛출판사','02-111-2222');
...
CREATE TABLE TB_BOOK(
    ...
    BK_TITLE VARCHAR2(50)CONSTRAINT NOT NULL,
    BK_AUTHOR VARCHAR2(20)CONSTRAINT NOT NULL,
    BK_PRICE NUMBER,
    BK_PUB_NO NUMBER CONSTRAINT BOOK_FK REFERENCE TB_PUBLISHER_2 ON DELETE CASCADE
    --GRADE_ID NUMBER REFERENCES TB_BOOK_GRADE ON DELETE CASCADE
);

--ALTER TABLE TB_BOOK ADD FOREIGN KEY (PUB_NO) REFERENCES TB_PUBLISHER;
